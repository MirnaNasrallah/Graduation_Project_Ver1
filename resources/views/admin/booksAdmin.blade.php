    ...
    <div class="container">
        <div class="row">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <li><a href="{{ route('shopAuth1') }}">Paulo Coelho</a></li>
                                                <li><a href="{{ route('shopAuth2') }}">Kristin Hannah</a></li>
                                                <li><a href="{{ route('shopAuth3') }}">Marian Keyes</a></li>
                                ...
                                <div class="card">
                                    <div class="card-heading">
                                        <a data-toggle="collapse" data-target="#collapseTwo">genre</a>
                                    </div>
                                    <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <li><a href="{{ route('shopNovel') }}">Novel</a></li>
                                                <li><a href="{{ route('shopkidBooks') }}">Kids</a></li>
                                                <li><a href="{{ route('shopEdu') }}">Educational</a></li>
                                                <li><a href="{{ route('shopHistory') }}">History</a></li>
                        ...
                        <div class="filter-range-wrap">
                            ...
                            <div class="range-slider">
                                <div class="price-input">
                                    <p>Price:</p>
                                    <form action="{{ route('priceLimitBooks') }}" method="GET">
            ...
            <div class="col-lg-9 col-md-9">
                <form class="d-flex justify-content-center" action="{{ route('createBook') }}" method="get">
                                    ...
                                    <div class="product__item sale">
                                        <div class="product__item__pic set-bg scaling mr-3"
                                            ...
                                            <ul class="product__hover">
                                                ...
                                                <li><a href="{{ url('destroyBook') }}/{{ $item->id }}"><span
                                                            class="icon_trash_alt"></span></a></li>
                                                <li><a href="{{ url('editBook') }}/{{ $item->id }}"><span
                                ...
                                @elseif ($item->sale == 0 && $item->quantity == 0)
                                 ...
                                 @elseif ($item->sale > 0 && $item->quantity == 0)
                                     <div class="product__item ">
                                        <div class="product__item__pic set-bg mr-3"
                                            data-setbg="{{ asset('storage/images/' . $item->product_img) }}">
                                            <div class="label stockout">Out Of Stock with Sale {{ $item->sale }}% </div>
