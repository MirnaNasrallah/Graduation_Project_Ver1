        ...
        <div class="col-md-10 m-auto">
            <div class="card card-block d-flex">
                <div class="card-header font-weight-bold text-center">
                    <h2><strong>{{ __('Admin Login') }} /
                            <a href="{{ route('login') }}">
                                <button class="mainButton">User Login</button>
                            </a>
                        </strong>
                    </h2>
                </div>
                <div class="row">
                    <div class="card-body col-7 align-items-center d-flex justify-content-center">
                        <form style="width: 550px;" method="POST" action="{{ route('adminPostLogin') }}">
                            @csrf
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-8 input-group">
                                    ...
                                    <input aria-describedby="forrEmail" id="email" type="email" placeholder="Enter Your Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8 input-group">
                                    <input aria-describedby="btnGroupAddon" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                    <div class="input-group-prepend">
