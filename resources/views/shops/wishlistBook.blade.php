                                        ...
                                        @foreach ($data as $item)
                                            <div class="product__item">
                                                <div class="product__item__pic set-bg"
                                                    data-setbg="{{ $item->product_img }}">
                                                    <div class="label new">New</div>
                                                    <ul class="product__hover">
                                                        <li><a href="img/shop/product_1.jpg"
                                                                class="image-popup"><span
                                                                    class="arrow_expand"></span></a></li>
                                                        <li><a href="{{ url('deletefromwishlistBook') }}/{{ $item->product_name }}"><span
                                                                    class="icon_heart_alt"></span></a></li>
                                                        <li><a href="{{ url('addtocartBook') }}/{{ $item->id }}"><span
